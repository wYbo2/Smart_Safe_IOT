...
end_x=start_x-leng*cos(angle) #calculate the pointer's end position x coordinate
_____________________________ #calculate the pointer's end position y coordinate
...
_____________________________________________________________ #add the pointer (a line) to the canvas 
